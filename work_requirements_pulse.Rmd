  ...
  mutate(
    medicaid = case_when(
      ...
      HLTHINS1 == -99 & HLTHINS2 == -99 & HLTHINS3 == -99 &
          ...
          HLTHINS7 == -99 & HLTHINS8 == -99 ~ NA_real_, # If they didn't answer any of the health insurance questions, assign them NA
      HLTHINS1 == -88 & HLTHINS2 == -88 & HLTHINS3 == -88 &
        HLTHINS4 == -88 & HLTHINS5 == -88 & HLTHINS6 == -88 &
        HLTHINS7 == -88 & HLTHINS8 == -88 ~ NA_real_, # If they didn't answer any of the health insurance questions, assign them NA
      TRUE ~ 0
    ),
    esi = case_when(
      HLTHINS1 == 1 ~ 1,
...
medicaid_quarter_plot <- ggplot(medicaid_quarter, aes(x = quarter, y = percentage, color = intervention, group = intervention)) +
  ...
  scale_color_discrete(labels = c("Alabama, Florida, Mississippi, South Carolina", "Georgia")) +
  theme_minimal() +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1),
    legend.position = "bottom"
