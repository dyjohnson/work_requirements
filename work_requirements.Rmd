...
merge_2123 <- merge_2123 %>%
  mutate(
    ...
    post = case_when(
      IYEAR == 2021 | IYEAR == 2022 | (IYEAR == 2023 & IMONTH %in% c("01", "02", "03")) ~ 0,
...
eligible <- survey_2123 %>%
  subset(
    state %in% c("Georgia", "South Dakota") &
      ...
      # IYEAR %in% c(2021, 2022, 2023) # Date range: 1/1/2021 - 12/31/2023
...
#ggsave("qualifying_quarter_plot_south.jpg")
...
#ggsave("student_quarter_plot_south.jpg")
...
pcp_quarter_plot
#ggsave("pcp_quarter_plot_south.jpg")
...
#ggsave("not_afford_quarter_plot_south.jpg")
...
#ggsave("unemployed_quarter_plot_south.jpg")
```
...
#ggsave("qualifying_half_plot_south.jpg")
...
student_half_plot
#ggsave("student_half_plot_south.jpg")
...
pcp_half_plot
#ggsave("pcp_half_plot_south.jpg")
...
#ggsave("not_afford_half_plot_south.jpg")
...
#ggsave("unemployed_half_plot_south.jpg")
```
...
```{r}
# Medicaid
medicaid_adj <- svyglm(medicaid ~ intervention * post + age_cat + sex_cat, design = eligible)
