...
```{r}
# Medicaid coverage
medicaid_summary <- svytable(~medicaid + post + intervention, eligible2) %>%
  as.data.frame() %>%
...
# ESI
esi_summary <- svytable(~esi + post + intervention, eligible2) %>%
  as.data.frame() %>%
  group_by(post, intervention) %>%
  summarize(
    total = sum(Freq),
...
# Uninsured
uninsured_summary <- svytable(~uninsured + post + intervention, eligible2) %>%
  as.data.frame() %>%
  group_by(post, intervention) %>%
  summarize(
    total = sum(Freq),
...
# Qualifying activities
qualifying_summary <- svytable(~qualifying + post + intervention, eligible2) %>%
  as.data.frame() %>%
  group_by(post, intervention) %>%
  summarize(
    total = sum(Freq),
...
# Employed
employed_summary <- svytable(~employed + post + intervention, eligible2) %>%
  as.data.frame() %>%
  group_by(post, intervention) %>%
  summarize(
    total = sum(Freq),
...
# Student
student_summary <- svytable(~student + post + intervention, eligible2) %>%
  as.data.frame() %>%
  group_by(post, intervention) %>%
  summarize(
    total = sum(Freq),
...
# PCP
pcp_summary <- svytable(~pcp + post + intervention, eligible2) %>%
  as.data.frame() %>%
  group_by(post, intervention) %>%
  summarize(
    total = sum(Freq),
...
not_afford_summary <- svytable(~not_afford + post + intervention, eligible2) %>%
  as.data.frame() %>%
  group_by(post, intervention) %>%
  summarize(
    total = sum(Freq),
...
# Unemployed
unemployed_summary <- svytable(~unemployed + post + intervention, eligible2) %>%
  as.data.frame() %>%
  group_by(post, intervention) %>%
  summarize(
    total = sum(Freq),
